// src/app/(DashboardLayout)/testing-page/geminiai/page.tsx
'use client';
...
const GeminiAIPage = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch('/api/aiApi/geminiApi', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className='container mx-auto p-4'>
      <CommonBreadcrumb pageTitle='Gemini AI Support' parent='AI Support' />
      <Card className='p-6'>
        <div className='space-y-4'>
          <h2 className='text-2xl font-bold'>Gemini AI Support</h2>
          <p className='text-muted-foreground'>Enter a term or concept to get an AI explanation using Gemini AI</p>
