// src/app/units/kbtk/kelola/layout.tsx
'use client';
...
const navItems: NavItem[] = [
  {
    label: 'Dashboard',
    href: '/units/kbtk/kelola',
    icon: LayoutDashboard,
  },
  {
    label: 'Data Siswa',
    href: '/units/kbtk/kelola/data-siswa',
    icon: Users,
  },
  {
    label: 'Pendaftaran',
  ...
  {
    label: 'Pengaturan',
    href: '/units/kbtk/kelola/pengaturan',
    icon: Settings,
  },
];
...
function SidebarNav({ onItemClick }: { onItemClick?: () => void }) {
  ...
  const isActive = (href: string) => {
    if (href === '/units/kbtk/kelola') {
      return pathname === '/units/kbtk/kelola';
    }
  ...
  return (
    <aside className="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 bg-white border-r border-gray-200 shadow-sm">
      ...
      <div className="flex items-center gap-3 px-6 py-5 border-b border-gray-100">
        ...
        <div>
          <h1 className="text-sm font-bold text-[#006064]">Kelola KBTK</h1>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="hidden sm:flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-br from-[#00BCD4]/10 to-[#006064]/10">
              <GraduationCap className="h-5 w-5 text-[#006064]" />
            </div>
            <div>
              <h1 className="text-lg font-bold text-[#006064]">
                Administrasi KBTK Al Muhajirin
              </h1>
...
export default function KBTKKelolaLayout({
  children,
}: {
      ...
      <footer className="lg:ml-64 border-t border-gray-200 mt-auto no-print">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <p className="text-center text-sm text-gray-500">
            KBTK Al Muhajirin Rewwin &copy; 2025 - Yayasan Al Muhajirin Rewwin
          </p>
        </div>
      </footer>
