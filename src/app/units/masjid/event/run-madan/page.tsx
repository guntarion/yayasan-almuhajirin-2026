...
// Import components
import { EventTabs, SenamInfo, SenamRegistration, SenamSuccessModal, EventTab, SenamRegistrationData } from './components';
  ...
  return (
    <div className='min-h-screen bg-gradient-to-b from-slate-50 to-white'>
          ...
          <div className='grid md:grid-cols-2 gap-12 items-center'>
            ...
            <div className='space-y-6'>
              ...
              <p className='text-lg text-white/80'>
                Bukan Lomba! Event olahraga santai untuk semua kalangan. Pilih aktivitasmu: <strong>Fun Run/Walk 3K</strong> atau{' '}
                <strong>Senam Sehat GRATIS</strong>. Menyambut Ramadhan & memperkenalkan layanan kesehatan gratis.
              </p>
              ...
              <div className='grid grid-cols-2 gap-3'>
                ...
                >
                  ...
                  <div className={`text-xs font-black mt-2 ${activeTab === 'senam' ? 'text-white' : 'text-[#4CAF50]'}`}>100% GRATIS!</div>
                </button>
              </div>
            ...
            <div className='container mx-auto px-4'>
              ...
              <div className='grid md:grid-cols-3 gap-8 max-w-6xl mx-auto'>
                {[
                  ...
                  <div
                    key={index}
                    className='bg-white rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:-translate-y-1 group'
                  >
                    <div
                      className={`w-14 h-14 md:w-16 md:h-16 rounded-xl bg-gradient-to-r ${item.color} flex items-center justify-center mb-6 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3`}
                    >
            ...
            <div className='container mx-auto px-4'>
                ...
                <div className='bg-gradient-to-br from-white to-[#addbf2]/30 rounded-2xl p-8 border-2 border-[#4e8fc0] shadow-lg'>
                  <div className='flex items-start gap-6'>
                    ...
                    <div className='flex-1'>
                      ...
                      <p className='text-gray-700 mb-4'>
                        Bagi lansia yang bersedia, kami menawarkan <strong>jadwal kunjungan check-up dan konsultasi kesehatan</strong> rutin di
                        Poliklinik Al Muhajirin.
                      </p>
                      <div className='grid md:grid-cols-2 gap-4'>
                        <div className='bg-white rounded-xl p-4 border border-[#043e75]'>
              ...
              <div className='max-w-4xl mx-auto mt-12 bg-gradient-to-br from-[#043e75] to-[#4e8fc0] rounded-2xl p-8 text-white text-center'>
                ...
                <p className='text-lg text-white/90 mb-6'>
                  Semua layanan kesehatan kami bersifat <strong>GRATIS</strong> untuk masyarakat. Di sisi lain, kami juga membuka kesempatan bagi
                  siapa saja yang ingin menjadi <strong>donatur tetap</strong> untuk mendukung keberlanjutan program layanan kesehatan ini.
                </p>
              ...
              <div className='max-w-4xl mx-auto mb-12 grid md:grid-cols-2 gap-6'>
                ...
                <div className='bg-gradient-to-br from-gray-400 via-gray-500 to-gray-600 rounded-3xl p-6 md:p-8 shadow-xl text-white text-center relative overflow-hidden opacity-75'>
                  ...
                  <div className='relative z-10'>
                    ...
                    <p className='text-lg md:text-xl text-white/70 mb-6 md:mb-8'>Dengan Jersey Eksklusif</p>
                    ...
                    <div className='bg-white/10 backdrop-blur-sm rounded-xl p-4 md:p-6 mb-6 border border-white/20'>
                      ...
                      <div className='text-4xl md:text-5xl font-black text-white/50 line-through decoration-red-500 decoration-4'>Rp 100.000</div>
                    </div>
                    ...
                    <div className='bg-red-600/30 backdrop-blur-sm rounded-xl p-3 md:p-4 border-2 border-red-400 mb-6'>
                      <div className='flex items-start gap-3 justify-center'>
                        ...
                        <p className='text-xs md:text-sm font-bold text-red-100'>Pendaftaran telah DITUTUP - Quota Habis!</p>
                      </div>
                    </div>
              ...
              <div className='max-w-4xl mx-auto bg-gradient-to-br from-red-50 to-white rounded-2xl p-8 border-2 border-red-300 shadow-lg'>
                ...
                <div className='grid md:grid-cols-2 gap-4 opacity-60'>
                  {allBenefits.map((benefit, index) => {
                    ...
                    return (
                      <div key={index} className={`flex items-start gap-3 ${isJersey ? 'opacity-40' : ''}`}>
                        {isJersey ? (
                      ...
                      <div className='flex items-start gap-4'>
                        ...
                        <div>
                          ...
                          <p className='text-lg leading-relaxed mb-4'>
                            <strong>SELURUH PESERTA</strong> diwajibkan mengenakan pakaian yang menutup aurat secara Islami dan layak, sesuai dengan
                            nilai-nilai kesopanan dan keislaman.
                          </p>
                          <div className='bg-white/20 backdrop-blur-sm rounded-xl p-4 border-2 border-white/40'>
                            ...
                            <ul className='space-y-2 text-base'>
                              <li className='flex items-start gap-2'>
                                ...
                                <span>
                                  Muslimah wajib mengenakan <strong>jilbab/kerudung</strong> yang menutup kepala, leher, dan dada
                                </span>
                              </li>
                              <li className='flex items-start gap-2'>
                                <Star className='h-5 w-5 mt-0.5 flex-shrink-0 text-[#addbf2]' />
                                <span>
                                  Pakaian <strong>tidak ketat</strong> dan menutup aurat dengan sempurna
                                </span>
                              </li>
                              <li className='flex items-start gap-2'>
                                <Star className='h-5 w-5 mt-0.5 flex-shrink-0 text-[#addbf2]' />
                                <span>
                                  Celana/rok panjang yang <strong>longgar</strong> dan tidak transparan
                                </span>
                              </li>
                            </ul>
                          </div>
                      ...
                      <div className='flex items-start gap-3'>
                        ...
                        <div>
                          <p className='text-gray-800 leading-relaxed'>
                            Ketentuan ini dibuat untuk menjaga nilai-nilai keislaman dan kenyamanan bersama. Peserta yang{' '}
                            <strong>tidak memenuhi ketentuan pakaian</strong> akan diminta untuk memperbaiki terlebih dahulu sebelum mengikuti acara.
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              <div className='max-w-5xl mx-auto'>
                <div className='relative aspect-[16/9] w-full rounded-3xl overflow-hidden shadow-2xl'>
                  ...
                  <div className='absolute bottom-0 left-0 right-0 p-8 md:p-12'>
                    <h3 className='text-3xl md:text-5xl font-black text-white mb-4 drop-shadow-xl'>Membangun Motivasi Lari Bersama Komunitas</h3>
                    <p className='text-lg md:text-xl text-white/95 font-semibold drop-shadow-lg max-w-3xl'>
                      Run-Madan adalah ruang aman bagi pelari pemula untuk menemukan motivasi, belajar teknik berlari yang benar, dan membangun
                      kebiasaan sehat bersama komunitas yang suportif. Tidak ada tekanan, hanya semangat untuk berkembang bersama!
                    </p>
                  </div>
                </div>
              </div>
          ...
          <section className='py-16 bg-white'>
            <div className='container mx-auto px-4'>
              <div className='text-center mb-12'>
                ...
                <p className='text-lg text-gray-600 max-w-3xl mx-auto'>
                  Setelah selesai lari, peserta akan mendapatkan <strong>sesi edukasi kesehatan GRATIS</strong> dengan materi praktis dan aplikatif
                  dari para ahli
                </p>
              </div>
                  ...
                  <div className='flex items-start gap-6'>
                    ...
                    <div className='flex-1'>
                      ...
                      <p className='text-lg text-gray-700 mb-4'>
                        <strong>Pengenalan tahapan berlari yang aman bagi pemula.</strong> Pelajari bagaimana memulai kebiasaan lari dari nol hingga
                        bisa menyelesaikan 5 kilometer dengan aman dan nyaman.
                      </p>
            ...
            <div className='container mx-auto px-4 relative z-10'>
              <div className='text-center mb-12'>
                ...
                <p className='text-xl text-white/90 max-w-3xl mx-auto'>
                  Sebagian dana pendaftaran disalurkan untuk mendukung operasional layanan kesehatan <strong>GRATIS</strong> dan program sosial
                  masyarakat. Layanan ambulans dan poliklinik tetap gratis - donasi sukarela sangat dihargai untuk keberlanjutan program.
                </p>
              </div>
              ...
              <div className='max-w-3xl mx-auto bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 text-center'>
                ...
                <p className='text-white/90 mb-6'>
                  Run-Madan 2026 didukung oleh <strong>LAZ Muhajirin (LAZMU)</strong>, lembaga zakat terpercaya yang telah berpengalaman dalam
                  penyaluran dana amal untuk masyarakat. Semua layanan kesehatan kami bersifat <strong>GRATIS</strong> - kami sangat menghargai donasi
                  sukarela untuk keberlanjutan program.
                </p>
                <div className='flex flex-wrap gap-4 justify-center'>
                  <a
                    href='https://lazmu.muhajirinrewwin.or.id'
                  ...
                  <ul className='space-y-3 text-gray-700'>
                    ...
                    <li className='flex items-start gap-2 bg-[#043e75]/10 p-4 rounded-xl border-2 border-[#043e75]'>
                      ...
                      <span className='font-bold text-[#043e75]'>
                        <strong className='text-lg'>WAJIB:</strong> Seluruh peserta harus mengenakan pakaian yang{' '}
                        <strong>menutup aurat secara layak dan Islami</strong>. Khususnya untuk peserta perempuan Muslim, wajib mengenakan
                        jilbab/kerudung dan pakaian yang tidak ketat. Peserta yang tidak memenuhi ketentuan akan diminta memperbaiki pakaian terlebih
                        dahulu.
                      </span>
                    </li>
              ...
              <div className='max-w-5xl mx-auto'>
                <div className='relative aspect-[16/9] w-full rounded-3xl overflow-hidden shadow-2xl'>
                  ...
                  <div className='absolute bottom-0 left-0 right-0 p-8 md:p-12'>
                    ...
                    <p className='text-lg md:text-xl text-white/95 font-semibold drop-shadow-lg max-w-3xl'>
                      Run-Madan adalah tentang membangun gaya hidup sehat bersama, bukan tentang siapa yang paling cepat. Mari berlari santai dan
                      nikmati kebersamaan!
                    </p>
                  </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className='hidden'>
                  ...
                  <div className='space-y-6'>
                    ...
                    {participants.map((participant, index) => (
                      <div
                        key={participant.id}
                        className='bg-white rounded-2xl p-4 md:p-8 shadow-lg border-2 border-gray-300 relative transition-all duration-300 hover:shadow-xl'
                      >
                        {/* Remove button */}
                  ...
                  <div className='bg-gradient-to-br from-[#043e75] to-[#4e8fc0] rounded-2xl p-8 text-center'>
                    <div className='mb-6'>
                      ...
                      <div className='text-5xl font-black text-[#addbf2]'>Rp {(participants.length * 50000).toLocaleString('id-ID')}</div>
                      <div className='text-white/80 text-sm mt-2'>{participants.length} Peserta × Rp 50.000</div>
                      <div className='text-yellow-300 text-xs mt-1 font-semibold'>Paket tanpa Jersey</div>
                    </div>
                    ...
                    <p className='text-white/80 text-sm mt-4'>Setelah mendaftar, Anda akan mendapatkan nomor registrasi dan instruksi pembayaran</p>
                  </div>
                </form>
              </div>
            </div>
              ...
              <div className='bg-white rounded-2xl md:rounded-3xl max-w-2xl w-full max-h-[85vh] md:max-h-[90vh] overflow-y-auto shadow-2xl animate-in zoom-in-95 duration-300'>
                ...
                <div className='p-4 md:p-8 space-y-4 md:space-y-6'>
                  ...
                  <div className='bg-[#addbf2]/20 rounded-xl p-6 border-2 border-[#043e75]'>
                    ...
                    <div className='text-sm text-gray-600 mt-2'>Simpan nomor ini untuk konfirmasi pembayaran</div>
                  </div>
                  ...
                  <div className='bg-yellow-50 rounded-xl p-6 border-2 border-yellow-400'>
                    ...
                    <div className='space-y-3 text-gray-700'>
                      ...
                      <div>
                        ...
                        <div className='text-2xl font-black text-[#043e75]'>Rp {registrationData.totalBiaya.toLocaleString('id-ID')}</div>
                      </div>
      ...
      {showSenamSuccessModal && senamRegistrationData && (
        <SenamSuccessModal data={senamRegistrationData} onClose={() => setShowSenamSuccessModal(false)} />
      )}
    </div>
  );
}
